...
function AttackBadge({
    ...
    return (
        <motion.div
            ...
            className={`flex flex-col items-center gap-2 px-8 py-4 bg-black/90 border-4 ${meta.border} skew-x-[-12deg] shadow-[0_0_40px_rgba(255,255,255,0.15)]`}
        >
            ...
            {show && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-ps-yellow/90 px-10 py-2 border-y-4 border-white skew-x-[-15deg] mb-4"
                    >
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <motion.span
                            ...
                            className="text-5xl font-black italic text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.5)]"
                        >
                            VS
                        </motion.span>
