...
export const KNOWN_EFFECT_IDS = new Set<string>([
    ...
    "support.draw_cards",
    // FC-027 Phase-1 primitives (resolved by type at runtime).
    "support.conditional",
    "support.attack_second",
    "support.force_self_attack",
    "support.rotate_enemy_attack",
    "support.atk_set",
    "support.atk_set_to_hp",
    "support.atk_add_hp",
    "support.enemy_atk_zero",
    "support.enemy_atk_set",
    "support.enemy_atk_lower",
    "support.enemy_atk_halve",
    "support.enemy_atk_mult",
    "support.hp_set",
    "support.enemy_hp_set",
    "support.hp_double",
    "support.enemy_hp_double",
    "support.hp_swap",
    "support.hp_copy_from_opponent",
    "support.enemy_hp_copy_from_own",
    "support.enemy_hp_heal",
    "support.change_enemy_specialty",
    "support.both_change_specialty",
